...
- Main observes the player's HealthComponent `died` signal to reveal `GAME OVER` and pause the run; the player's local death handler stops movement and disables its attack first.
